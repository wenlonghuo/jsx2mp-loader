...
var _require5 = require('./utils/judgeModule'),
    isNpmModule = _require5.isNpmModule,
    isJSONFile = _require5.isJSONFile,
...
var _require6 = require('./output'),
    ...
    transformCode = _require6.transformCode;

var _require7 = require('./constants'),
    QUICKAPP = _require7.QUICKAPP;
        ...
        for (var key in componentConfig.usingComponents) {
          if (componentConfig.usingComponents.hasOwnProperty(key)) {
            ...
            if (isNpmModule(componentPath)) {
              ...
              var realComponentPath = require.resolve(componentPath, {
